...
export const HomeLogo = ({ navigate }: LogoProps) => {
  return (
    <svg
...
export function MovieIcon({ navigate }: LogoProps) {
  return (
    <svg
...
export function SeriesIcon({ navigate }: LogoProps) {
  return (
    <svg
...
export function BookmarkIcon({ navigate }: LogoProps) {
  return (
    <svg
