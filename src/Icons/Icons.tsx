    ...
    >
      <g transform='translate(4,4)'>
        <path
          ...
          className={`${
            direction !== "home" && "hover:fill-red-500"
          }`}
        />
      </g>
    </svg>
  ...
  return (
    ...
    >
      <path
        ...
        className={`${direction !== "movie" && "hover:fill-red-500"}`}
        strokeLinecap='round'
...
export function SeriesIcon({
  ...
  return (
    <svg
      ...
      className={`${direction === "series" ? "w-8 h-8" : "w-6 h-6"} ${
        direction !== "series" && "hover:stroke-red-900"
  ...
  return (
    ...
    >
      <path
        ...
        className={`${
          direction !== "bookMarked" && "hover:fill-red-500"
        }`}
        strokeLinecap='round'
        strokeLinejoin='round'
